...
export const EditConsultores = () => {
  ...
  const { findedDocConsultores, loading, setLoading } = useDb({
    dbRoute: "consultores",
    id: id,
  });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await updateDoc(docRef, modifiedDoc);
  ...
  useEffect(() => {
    if (findedDocConsultores) {
      console.log(findedDocConsultores);
      setFormData({
        area_de_expertise_1: findedDocConsultores.area_de_expertise_1,
        area_de_expertise_2: findedDocConsultores.area_de_expertise_2,
        avatar_image: findedDocConsultores.avatar_image,
        industria: findedDocConsultores.industria,
        idiomas: findedDocConsultores.idiomas,
        especialidad_1: findedDocConsultores.especialidad_1,
        especialidad_2: findedDocConsultores.especialidad_2,
        especialidad_3: findedDocConsultores.especialidad_3,
        especialidad_4: findedDocConsultores.especialidad_4,
        especialidad_5: findedDocConsultores.especialidad_5,
        nombre_completo: findedDocConsultores.nombre_completo,
        titulo_credencial_1: findedDocConsultores.titulo_credencial_1,
        titulo_credencial_2: findedDocConsultores.titulo_credencial_2,
        titulo_credencial_3: findedDocConsultores.titulo_credencial_3,
        ubicacion: findedDocConsultores.ubicacion,
        descripcion: findedDocConsultores.descripcion,
        publicaciones_relacionadas: [],
        linkedin: findedDocConsultores.linkedin,
        email: findedDocConsultores.email,
      });
      setSelectedPublicaciones(findedDocConsultores.publicaciones_relacionadas);
    }
      ...
      >
        <form className="mt-8  space-y-6" onSubmit={handleSubmit}>
          <div className=" grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                >
                  {findedDocConsultores &&
                  findedDocConsultores.industria.length > 0
                    ? formData.industria
                        .map(
                          (industria) =>
          ...
          <div className="w-full justify-center items-center flex">
            <FromDevzButton
              text={`${loading ? "" : "Actualizar consultor"}`}
              submitType={true}
            >
                  ...
                  <div className="relative w-60 h-60 rounded-lg border-[.5px] border-neutral-800 flex flex-col justify-center items-center gap-10 px-5">
                    ...
                    {selectedPublicaciones.includes(item.id) ? (
                      <FromDevzButton
                        ...
                        click={() => handleDeletePublicacion(item.id)}
                      >
                        <X />
                      </FromDevzButton>
                    ) : (
